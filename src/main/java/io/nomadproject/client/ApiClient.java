...
public class ApiClient {
    ...
    private String basePath = "http://127.0.0.1:4646/v1";
    ...
    public ApiClient() {
        ...
        authentications.put("X-Nomad-Token", new ApiKeyAuth("header", "X-Nomad-Token"));
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/1.7.6/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://127.0.0.1:4646/v1
